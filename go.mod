module github.com/spark8899/lotus_exporter
...
require (
	...
	github.com/filecoin-project/go-data-transfer v1.14.1 // indirect
	github.com/filecoin-project/go-fil-markets v1.19.2 // indirect
